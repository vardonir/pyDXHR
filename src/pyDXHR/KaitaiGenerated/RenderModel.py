...
class RenderModel(KaitaiStruct):
    ...
    def _read(self):
        ...
        self.header = RenderModel.MeshData(self._io, self, self._root)
    ...
    class MeshData(KaitaiStruct):
        ...
        def _read_le(self):
            self.header = RenderModel.MeshData.MeshHeader(self._io, self, self._root, self._is_le)
        ...
        class MeshTable(KaitaiStruct):
            ...
            class VtxSemInfo(KaitaiStruct):
                ...
                def _read_le(self):
                    ...
                    for i in range(self.len_vtx_sem):
                        self.semantics.append(RenderModel.MeshData.MeshTable.VtxSem(self._io, self, self._root, self._is_le))
            ...
            def vtx_sem_info(self):
                ...
                if self._is_le:
                    self._m_vtx_sem_info = RenderModel.MeshData.MeshTable.VtxSemInfo(self._io, self, self._root, self._is_le)
                else:
                    self._m_vtx_sem_info = RenderModel.MeshData.MeshTable.VtxSemInfo(self._io, self, self._root, self._is_le)
                self._io.seek(_pos)
        ...
        def mesh_table(self):
            ...
            if self._is_le:
                ...
                for i in range(self.header.len_mesh_count):
                    self._m_mesh_table.append(RenderModel.MeshData.MeshTable(self._io, self, self._root, self._is_le))
        ...
        def mesh_prim_table(self):
            ...
            if self._is_le:
                ...
                for i in range(self.header.len_mesh_prim):
                    self._m_mesh_prim_table.append(RenderModel.MeshData.MeshPrimHeader(self._io, self, self._root, self._is_le))
