...
def decompress(data: bytes, header_only: bool = False) -> List[bytes]:
    ...
    # https://github.com/gibbed/Gibbed.CrystalDynamics/blob/master/projects/Gibbed.CrystalDynamics.FileFormats/CompressedDrmFile.cs#L89
    # includes a basePosition variable, but I guess that's because his decompression input is a file buffer whereas
    # I'm reading the file from the beginning? i thiiiiiink my basePosition is zero in this case
